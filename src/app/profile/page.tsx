...
export default function ProfilePage() {
  ...
  if (!user) return <div className="text-center p-10 text-[var(--foreground)]">Yükleniyor...</div>;
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[var(--background)] pt-24 px-4 text-[var(--foreground)] transition-colors duration-300">
        <div className="max-w-3xl mx-auto p-6 bg-[var(--card-bg)] text-[var(--card-text)] rounded-2xl shadow-xl border border-[var(--border-color)] space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold mb-2">Profil Bilgilerim</h1>
            <p className="text-sm text-[var(--foreground)] opacity-70">Aşağıdaki bilgileri güncelleyebilirsiniz.</p>
          </div>

          <div className="flex flex-col items-center gap-4">
            <div className="w-28 h-28 relative rounded-full overflow-hidden border-4 border-purple-300 shadow-md">
              <Image
                src={profilePicture}
                alt="Profil"
                fill
            ...
            >
              <label
                htmlFor="profile"
                className="cursor-pointer bg-[var(--background)] px-4 py-2 rounded border border-[var(--border-color)] text-sm hover:bg-opacity-90"
              >
                Dosya Seç
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                value={user.username}
                disabled
                className="w-full p-2 border border-[var(--border-color)] bg-[var(--background)] rounded-lg"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full p-2 border border-[var(--border-color)] bg-[var(--card-bg)] text-[var(--card-text)] rounded-lg"
              />
            </div>
            <div>
          ...
          <div className="w-full mt-6">
            <div className="flex justify-between items-center mb-1 px-1">
              <span className="text-sm font-medium">Tamamlanma Durumu</span>
